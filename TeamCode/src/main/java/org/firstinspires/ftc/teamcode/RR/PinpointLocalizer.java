...
public final class PinpointLocalizer implements Localizer {
    ...
    public static class Params {
        public double parYTicks = robotConfig.setConfig(17); // y position of the parallel encoder (in tick units)
        public double perpXTicks = robotConfig.setConfig(18); // x position of the perpendicular encoder (in tick units)
    }
    ...
    public PinpointLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        driver = hardwareMap.get(GoBildaPinpointDriver.class, Port.Pinpoint);
